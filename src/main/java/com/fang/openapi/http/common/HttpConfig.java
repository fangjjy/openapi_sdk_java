...
//    }
    ...
    public HttpConfig json(String json) {
        ...
        map.put(HttpUtils.ENTITY_STRING, json);
        return this;
    }
    ...
    public HttpConfig files(String[] filePaths, String inputName, boolean forceRemoveContentTypeChraset) {
        ...
        map.put(HttpUtils.ENTITY_MULTIPART, filePaths);
        map.put(HttpUtils.ENTITY_MULTIPART + ".name", inputName);
        map.put(HttpUtils.ENTITY_MULTIPART + ".rmCharset", forceRemoveContentTypeChraset);
        return this;
    }
